...
const MENU = [
  ...
  { hash: '#/scan-in', label: 'Nhập kho', icon: 'box-arrow-in-down', perm: 'warehouse.inventory_in' },
  { hash: '#/scan-out', label: 'Xuất kho', icon: 'box-arrow-up', perm: 'warehouse.inventory_out' },
